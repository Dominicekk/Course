...
console.log(maskCreditCard(4415144984986348));
console.log(maskCreditCard('49849849849846512619481'));
...
const announcement = 'All passengers come to boarding door 23. Boearding door 23!'
